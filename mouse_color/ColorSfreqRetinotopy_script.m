...
[f1 R Rfit] = CondF1_cellMask2(.4);
%OnePeriodKal = getOnePeriod;
...
%Looks like it might be on a border.. LM?
%%%%%%First get 0 and 90%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%Now get Kalatsky info and compare to S/M %%%%%%%%%%%%%%%%
expt = 'u000_001'; %Kalatsky
%expt = 'u000_011'; %Kalatsky
traceroot = 'C:\CellTraces\';
tracepath = [traceroot anim '_' expt '_cellS_aligned to 2_9'];
load(tracepath,'cellS')
set(G_handles.datadir,'string',[dataRoot anim '\' anim '_' expt(2:end)])
