function [mu sigma ffit varacc param] = CircGaussFit2(f,xx)

%2 allows for an arbitrary domain.  For example, could be a train.
%xx should be in radians
...
x0 = [xx(idx) 5 ma-mi mi];

%% search
param = fminsearch('CircGaussFit_handle2',x0);
