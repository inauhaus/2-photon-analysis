function BSclustering2(oripref,sfpref,phase,tcori,tcsf,doriAll,dsfAll,dphaseAll,doriEucAll,dsfEucAll,distAll,animID,animIDdAll)
...
%%
ND = length(distdom); 
doriBS2 = cell(1,ND); dsfBS2 = cell(1,ND); dphaseBS2 = cell(1,ND); doriEucBS2 = cell(1,ND); dsfEucBS2 = cell(1,ND);
for d = 1:ND
    for R = 1:length(adom)
...
figure,errorbar(distdom,domu,dosig)
hold on
errorbar(distdom,dsfmu,dsfsig,'r')
