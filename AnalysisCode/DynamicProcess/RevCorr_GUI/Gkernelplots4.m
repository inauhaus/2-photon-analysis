...
%getTCfromRevCorr3
Downsample = 0;
getTCfromRevCorr7(Downsample) %allows for downsampling with color expts

%%
%pairWiseRCanalysis2

%%
[maporidiff mapslopemag] = plotRCmaps_dots;
%plotRCmaps_dots_paper
%plotRCmaps_dots_paper_modelPred
