...
% Last Modified by GUIDE v2.5 05-Apr-2016 11:30:18
...
global Analyzer cellS kernels kernblank G_RChandles kernSig
...
switch Analyzer.P.type
    ...
    case 'FG'        
        Ggetrevcorrkernel3(cellS.cellMat,trialdom,hh);
...
switch Analyzer.P.type
    ...
    case 'FG'
        [kernelsIm] = Ggetrevcorrkernel_image3(trialdom,hh);
        set(handles.plot,'enable','on')
...
global Analyzer axismap logmap

switch Analyzer.P.type

    case 'FG'
        axismap = plotRevCorrMap;
        logmap = plotRevCorrMap_log;
...
function STMovieTimeWindow_Callback(hObject, eventdata, handles)
% hObject    handle to STMovieTimeWindow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of STMovieTimeWindow as text
%        str2double(get(hObject,'String')) returns contents of STMovieTimeWindow as a double


% --- Executes during object creation, after setting all properties.
function STMovieTimeWindow_CreateFcn(hObject, eventdata, handles)
% hObject    handle to STMovieTimeWindow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in SaveSTPixelMaps.
function SaveSTPixelMaps_Callback(hObject, eventdata, handles)
% hObject    handle to SaveSTPixelMaps (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
path = 'c:\';
filename = path;
uisave({'axismap','logmap'},filename)
